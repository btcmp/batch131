...
public class ProductDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("bisalah ayooo",""+nama_product);
            ...
            for (int i = 0; i < showMenus.length; i++) {
                ...
                GoToChart.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        GotoChart(nama_product,qty3,hasil4);
                    }
                });
    ...
    public void GotoChart(String name_product, int qtyAja, int price){
        ...
        if(countData.getCount() > 0){
            ...
            db.execSQL("UPDATE "+table+" SET kuantity = '"+ qtyAja +"' WHERE id_produk = '"+id_pr_GoToChart+"' AND id_user = '"+idUser+"'");
            db.execSQL("UPDATE ordermenu SET subtotal = '"+ subtotal + "' WHERE id_produk = '"+id_pr_GoToChart+"' AND id_user = '"+idUser+"'");
            db.execSQL("UPDATE history SET quantity = '"+ qtyAja +"' WHERE idProduk = '"+id_pr_GoToChart+"' AND namaUser = '"+nameUser+"'");
            ...
            SQLiteDatabase db = sqLiteDBHelper.getWritableDatabase();
            db.execSQL("INSERT INTO "+table+"(id_user,nama_user,id_kategori_produk,id_produk,kuantity,subtotal) " +
